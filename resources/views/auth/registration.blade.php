                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center pl-0 pr-3 py-0">
                                    <img src="{{ asset('templates') }}/app-assets/images/pages/register.jpg"
                                        alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <p class="px-2">Isi Data Dibawah Untuk Mendaftar.</p>
                                        <div class="card-content">
                                            ...
                                            <div class="card-body pt-0">
                                                <form action="{{ route('register.custom') }}" method="POST">
                                                    ...
                                                    <div class="form-label-group">
                                                        <div class="form-group">
                                                            <select class="custom-select" name="prodi"
                                                                id="customSelect" required>
                                                                <option value="IF-S1" selected>Teknik Informatika - S1
                                                                </option>
                                                        ...
                                                        <label for="customSelect">Prodi</label>
                                                    </div>
                                                    <div class="form-label-group">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-primary float-right btn-inline mb-50">Daftar</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>

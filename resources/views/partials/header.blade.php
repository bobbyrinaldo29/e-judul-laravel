...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('templates') }}/app-assets/vendors/css/tables/datatable/datatables.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/vendors/css/extensions/tether-theme-arrows.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/vendors/css/extensions/tether.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/vendors/css/extensions/shepherd-theme-default.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/vendors/css/pickers/pickadate/pickadate.css">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('templates') }}/app-assets/css/pages/coming-soon.css">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/css/themes/semi-dark-layout.css">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/css/pages/dashboard-analytics.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates') }}/app-assets/css/pages/card-analytics.css">
    <!-- END: Page CSS-->
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/css/core/menu/menu-types/horizontal-menu.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates') }}/app-assets/css/core/colors/palette-gradient.css">
